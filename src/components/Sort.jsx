...
export const sortList = [{name: 'популярности (по убыванию)', sortProperty: 'rating'}, 
...
function Sort() {
    ...
    //закрытие блока сортировки при клике не на него
    React.useEffect(() => {
    ...
    return (
      <div ref={sortRef} className="sort">
        <div className="sort__label">
          ...
          <b>Сортировка по:</b>
          <span onClick={() => setOpenPopup(!isOpenPopup)}>{sort.name}</span>
        </div>
        {isOpenPopup && (
